...
namespace SecretSanta.Web.Data
{
    public static class MockData
    {
        ...
        {
            new UserViewModel {FirstName = "John", LastName = "Doe", GroupName="Anonymous", UserID=0},
            new UserViewModel {FirstName = "Jane", LastName = "Doe", GroupName="Anonymous", UserID=1},
        };

        public static List<GiftViewModel> GiftsList = new List<GiftViewModel>
        {
